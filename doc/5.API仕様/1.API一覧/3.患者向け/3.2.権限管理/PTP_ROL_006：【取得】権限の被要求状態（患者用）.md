...
| No. | 項目名 | 物理名 | 属性 | Nullable | 設定要領 |
| :--- | :--- | :--- | :--: | :--: | :--- |
| 1 | 権限承認ID | permissionApprovalId | string | - | 権限承認IDを設定する。クエリパラメータ指定が無い場合は必須入力となる。 |
...
<!-- ↓↓↓ここに書く↓↓↓ -->
＜パスパラメータ指定の場合＞<br/>
　　{applicationPath}/participants/permission/approval/3fa04331-85fd-4cb5-819d-d240145a74ca<br/>
＜クエリパラメータ指定の場合＞<br/>
　　{applicationPath}/participants/permission/approval?status=1<br/>
<!-- ↑↑↑ここに書く↑↑↑ -->
</td></tr></table>
